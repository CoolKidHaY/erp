...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , serverUrl: window.CTX + "/common/ueditor/config"
        ...
        //     'simpleupload', 'insertimage', 'emotion', 'link', 'unlink', 'anchor'
        // ]]
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion', 'scrawl', 'map', '|',
            'horizontal', 'date', 'time', 'spechars', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
            'searchreplace', 'attachment'
        ]]
		...
		,whitList: {
			iframe: ['frameborder','width','height','src','class','data-vh','data-vw','style','data-src','data-w','data-ratio','data-cover','data-mpvid','data-vidtype','allowfullscreen'],
